...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Insertar el proceso con los totales calculados
        $stmt = $pdo->prepare("
            INSERT INTO tb_procesos (nombre, costo, costo_terceros, tiempo_max_entrega, estado) 
            VALUES (?, ?, ?, ?, 'Activo')
        ");
        ...
        $proceso_id = $pdo->lastInsertId();
        
        // Insertar las operaciones del proceso con sus valores individuales
        $stmt = $pdo->prepare("
